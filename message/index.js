    ...
    try {
        ...
        if (isGroupMsg && !isGroupAdmins && isBotGroupAdmins && isDetectorOn && !isOwner) {
            if (chats.match(new RegExp(/(https:\/\/chat.whatsapp.com)/gi))) {
                ...
                if (valid) {
                    ...
                    await hisoka.reply(from, ind.linkDetected(), id)
            ...
            if (isUrl(chats)) {
                ...
                isPorn(classify.hostname, async (err, status) => {
                    ...
                    if (status) {
                        ...
                        await hisoka.reply(from, ind.linkNsfw(), id)
                        await hisoka.removeParticipant(groupId, sender.id)
                    } else {
        ...
        if (isGroupMsg) {
            for (let ment of mentionedJidList) {
                if (afk.checkAfkUser(ment, _afk)) {
                    ...
                    await hisoka.reply(from, ind.afkMentioned(getReason, getTime), id)
                }
            }
            if (afk.checkAfkUser(sender.id, _afk) && !isCmd) {
                _afk.splice(afk.getAfkPosition(sender.id, _afk), 1)
                fs.writeFileSync('./database/user/afk.json', JSON.stringify(_afk))
                await hisoka.sendText(from, ind.afkDone(pushname))
            }
        }
        ...
        */
        ...
        switch (command) {
            ...
            // Register by Slavyan
            case 'register':
                if (isRegistered) return await hisoka.reply(from, ind.registeredAlready(), id)
                if (isGroupMsg) return await hisoka.reply(from, ind.pcOnly(), id)
                if (!q.includes('|')) return await hisoka.reply(from, ind.wrongFormat(), id)
                const namaUser = q.substring(0, q.indexOf('|') - 1)
                const umurUser = q.substring(q.lastIndexOf('|') + 2)
                const serialUser = createSerial(20)
                if (Number(umurUser) >= 40) return await hisoka.reply(from, ind.ageOld(), id)
                register.addRegisteredUser(sender.id, namaUser, umurUser, time, serialUser, _registered)
                await hisoka.reply(from, ind.registered(namaUser, umurUser, sender.id, time, serialUser), id)
            ...
            case 'level':
                ...
                if (!isLevelingOn) return await hisoka.reply(from, ind.levelingNotOn(), id)
                if (!isGroupMsg) return await hisoka.reply(from, ind.groupOnly(), id)
                const userLevel = level.getLevelingLevel(sender.id, _level)
            ...
            case 'leaderboard':
                ...
                try {
                    ...
                    console.error(err)
                    await hisoka.reply(from, ind.minimalDb(), id)
                }
            break
            ...
            case 'joox': // By Hafizh
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!q) return await hisoka.reply(from, ind.wrongFormat(), id)
                ...
                cardJoox.build()
                    .then(async (buffer) => {
                        ...
                        await hisoka.sendFile(from, `${sender.id}_joox.png`, 'joox.png', ind.joox(dataJoox.data), id)
            ...
            case 'instadl':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!isUrl(url) && !url.includes('instagram.com')) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await hisoka.reply(from, ind.wait(), id)
            ...
            case 'facebook':
            case 'fb':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(pushname), id)
                if (!isUrl(url) && !url.includes('facebook.com')) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await hisoka.reply(from, ind.wait(), id)
                downloader.fb(url)
            ...
            case 'ytmp3':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!isUrl(url) && !url.includes('youtu.be')) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await hisoka.reply(from, ind.wait(), id)
                downloader.ytdl(url)
                    .then(async (res) => {
                        if (res.status === 'error') {
                            ...
                            await hisoka.reply(from, ind.videoLimit(), id)
                        } else {
                            await hisoka.sendFileFromUrl(from, res.thumbnail, `${res.title}.jpg`, ind.ytFound(res), id)
            ...
            case 'tktnowm':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!isUrl(url) && !url.includes('tiktok.com')) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await hisoka.reply(from, ind.wait(), id)
            ...
            case 'twt':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!isUrl(url) && !url.includes('twitter.com')) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await hisoka.reply(from, ind.wait(), id)
            ...
            case 'linedl': // chikaa chantexxzz
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (isGroupMsg) return await hisoka.reply(from, ind.pcOnly(), id)
                if (!isUrl(url) && !url.includes('store.line.me')) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                downloader.line(url)
                    .then(async (res) => {
            ...
            case 'afk': // by Slavyan
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!isGroupMsg) return await hisoka.reply(from, ind.groupOnly(), id)
                if (isAfkOn) return await hisoka.reply(from, ind.afkOnAlready(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                const reason = q ? q : 'Nothing.'
                afk.addAfkUser(sender.id, time, reason, _afk)
                await hisoka.reply(from, ind.afkOn(pushname, reason), id)
            break
            case 'lyric':
            case 'lirik':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
            ...
            case 'shortlink':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!isUrl(url)) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
            ...
            case 'igstory':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!q) return hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await hisoka.reply(from, ind.wait(), id)
                misc.its(q)
            ...
            case 'gsmarena':
                ...
                try {
                    misc.gsmarena(q)
                        .then(async ({ result }) => {
                            await hisoka.sendFileFromUrl(from, result.image, `${result.title}.jpg`, ind.gsm(result), id)
            ...
            case 'resep':
                ...
                try {
                    misc.resep(q)
                        .then(async ({ result }) => {
                            await hisoka.sendFileFromUrl(from, result.image, `${result.title}.jpg`, ind.receipt(result), id)
                    ...
                    misc.ytSearch(q)
                        .then(async ({ result }) => {
                            for (let i = 0; i < 5; i++) {
                                ...
                                await hisoka.sendFileFromUrl(from, image, `${title}.jpg`, ind.ytResult(urlyt, title, channel, duration, views), id)
            ...
            case 'tomp3': // by: Piyobot
                ...
                if ((isMedia && isVideo || isQuotedVideo)) {
                    ...
                    await hisoka.reply(from, ind.wrongFormat(), id)
                }
            break
            case 'playstore':
            case 'ps':
                    ...
                    misc.playstore(q)
                        .then(async ({ result }) => {
                            for (let i = 0; i < 5; i++) {
                                ...
                                await hisoka.sendFileFromUrl(from, icon, `${title}.jpg`, ind.playstore(app_id, title, developer, description, price, free))
                            }
            ...
            case 'math':
                ...
                if (typeof mathjs.evaluate(q) !== 'number') {
                    await hisoka.reply(from, ind.notNum(q), id)
                } else {
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    ...
                    misc.shopee(namaBarang, jumlahBarang)
                        .then(async ({ result }) => {
                            for (let i = 0; i < result.items.length; i++) {
                                ...
                                await hisoka.sendFileFromUrl(from, image_cover, `${nama}.jpg`, ind.shopee(nama, harga, terjual, shop_location, description, link_product))
                            }
            ...
            case 'hadees':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (args.length !== 2) return await hisoka.reply(from, ind.hadis(), id)
                await hisoka.reply(from, ind.wait(), id)
                try {
                    if (ar[0] === 'darimi') {
                        ...
                        await hisoka.sendText(from, ind.hadis(), id)
                    }
                } catch (err) {
                    console.error(err)
                    await hisoka.reply(from, 'Error!', id)
            ...
            case 'asmaulhusna': // irham01
                ...
                hisoka.sendFileFromUrl(from, 'https://i2.wp.com/seruni.id/wp-content/uploads/2016/09/Allah.png?resize=696%2C696&ssl=1', 'gambar.jpg', ind.asmaulHusna(assna), id)
            break
            case 'randomquran': // irham01
                ...
                await hisoka.reply(from, ind.randomQuran(ranquran), id)
            ...
            case 'play':
                ...
                misc.ytPlay(q)
                    .then(async ({ result }) => {
                        ...
                        await hisoka.sendFileFromUrl(from, result.image, `${result.title}.jpg`, ind.ytPlay(result), id)
            ...
            case 'spamsms':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (args.length !== 2) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (isNaN(Number(args[0])) && isNaN(Number(args[1]))) return await hisoka.reply(from, ind.wrongFormat(), id)
            ...
            case 'help':
                ...
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (args[0] === '1') {
                    await hisoka.sendText(from, ind.menuDownloader())
                } else if (args[0] === '2') {
                    await hisoka.sendText(from, ind.menuBot())
                } else if (args[0] === '3') {
                    await hisoka.sendText(from, ind.menuMisc())
                } else if (args[0] === '4') {
                    await hisoka.sendText(from, ind.menuSticker())
                } else if (args[0] === '5') {
                    await hisoka.sendText(from, ind.menuWeeaboo())
                } else if (args[0] === '6') {
                    await hisoka.sendText(from, ind.menuFun())
                } else if (args[0] === '7') {
                    await hisoka.sendText(from, ind.menuModeration())
                } else if (args[0] === '8') {
                    if (isGroupMsg && !isNsfw) return await hisoka.reply(from, ind.notNsfw(), id)
                    await hisoka.sendText(from, ind.menuNsfw())
                } else if (args[0] === '9') {
                    if (!isOwner) return await hisoka.reply(from, ind.ownerOnly())
                    await hisoka.sendText(from, ind.menuOwner())
                } else if (args[0] === '10') {
                    if (!isGroupMsg) return await hisoka.reply(from, ind.groupOnly(), id)
                    await hisoka.sendText(from, ind.menuLeveling())
                } else {
                    await hisoka.sendText(from, ind.menu(jumlahUser, levelMenu, xpMenu, role, pushname, reqXpMenu, isPremium ? 'YES' : 'NO'))
                }
            break
            case 'rules':
            case 'rule':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                await hisoka.sendText(from, ind.rules())
            break
            case 'nsfw':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!isGroupMsg) return await hisoka.reply(from, ind.groupOnly(), id)
                if (!isGroupAdmins) return await hisoka.reply(from, ind.adminOnly(), id)
                if (ar[0] === 'enable') {
                    if (isNsfw) return await hisoka.reply(from, ind.nsfwAlready(), id)
                    _nsfw.push(groupId)
                    fs.writeFileSync('./database/group/nsfw.json', JSON.stringify(_nsfw))
                    await hisoka.reply(from, ind.nsfwOn(), id)
                } else if (ar[0] === 'disable') {
                    _nsfw.splice(groupId, 1)
                    fs.writeFileSync('./database/group/nsfw.json', JSON.stringify(_nsfw))
                    await hisoka.reply(from, ind.nsfwOff(), id)
                } else {
                    await hisoka.reply(from, ind.wrongFormat(), id)
                }
            break
            ...
            case 'del':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!quotedMsg) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (!quotedMsgObj.fromMe) return await hisoka.reply(from, ind.wrongFormat(), id)
                await hisoka.deleteMessage(quotedMsgObj.chatId, quotedMsgObj.id, false)
            break
            case 'report':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!q) return await hisoka.reply(from, ind.emptyMess(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                ...
                if (lastReport !== undefined && cd - (Date.now() - lastReport) > 0) {
                    ...
                    await hisoka.reply(from, ind.daily(time), id)
                } else {
                    if (isGroupMsg) {
                        await hisoka.sendText(ownerNumber, `-----[ REPORT ]-----\n\n*From*: ${pushname}\n*ID*: ${sender.id}\n*Group*: ${(name || formattedTitle)}\n*Message*: ${q}`)
                        await hisoka.reply(from, ind.received(pushname), id)
                    } else {
                        await hisoka.sendText(ownerNumber, `-----[ REPORT ]-----\n\n*From*: ${pushname}\n*ID*: ${sender.id}\n*Message*: ${q}`)
                        await hisoka.reply(from, ind.received(pushname), id)
                    }
            ...
            case 'tos':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                await hisoka.sendLinkWithAutoPreview(from, 'https://github.com/dxxoo/HisokaBOT-Whatsapp-Bot', ind.tos(ownerNumber))
            break
            case 'join':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!isUrl(url) && !url.includes('chat.whatsapp.com')) return await hisoka.reply(from, ind.wrongFormat(), id)
                const checkInvite = await hisoka.inviteInfo(url)
                if (isOwner) {
                    await hisoka.joinGroupViaLink(url)
                    await hisoka.reply(from, ind.ok(), id)
            ...
            case 'cekpremium':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!isPremium) return await hisoka.reply(from, ind.notPremium(), id)
            ...
            break
            case 'serial':
                if (!isRegistered) return await hisoka.reply(from, ind.registered(), id)
                if (isGroupMsg) return await hisoka.reply(from, ind.pcOnly(), id)
                if (args.length !== 1) return await hisoka.reply(from, ind.wrongFormat(), id)
                ...
                if (register.checkRegisteredUserFromSerial(serials, _registered)) {
                    ...
                    await hisoka.sendText(from, ind.registeredFound(name, age, time, serials, id))
                } else {
                    await hisoka.sendText(from, ind.registeredNotFound(serials))
                }
            break
            case 'limit':
            ...
            case 'me':
                ...
                if (quotedMsg) {
                    ...
                    await hisoka.sendFileFromUrl(from, pfp, `${username}.jpg`, ind.profile(username, status, premi, benet, adm, levelMe, req, xpMe), id)
                } else {
                    ...
                    await hisoka.sendFileFromUrl(from, pfps, `${username}.jpg`, ind.profile(username, status, premi, benet, adm, levelMe, req, xpMe), id)
                }
            break
            case 'hartatahta':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
            ...
            case 'ffbanner': // By: VideFrelan
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!q.includes('|')) return hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await hisoka.reply(from, ind.wait(), id)
            ...
            case 'caklontong': //By: VideFrelan
                if (!isGroupMsg) return hisoka.reply(from, ind.groupOnly(), id)
                if (!isRegistered) return  hisoka.reply(from, ind.notRegistered(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await hisoka.reply(from, ind.wait(), id)
                const sleep = (ms) => {
            ...
            case 'text': // by: irham01
                ...
                try {
                    if (ar[0] === 'burnpaper') {
                        ...
                        await hisoka.reply(from, ind.menuText(), id)
                    }
                } catch (err) {
                    console.error(err)
                    await hisoka.reply(from, 'Error!', id)
                ...
                if (isMedia && type === 'video' || mimetype === 'image/gif' || isQuotedVideo || isQuotedGif) {
                    ...
                    try {
                        ...
                        await hisoka.sendMp4AsSticker(from, videoBase64, { fps: 30, startTime: '00:00:00.0', endTime : '00:00:05.0', loop: 0 })
                            .then(async () => {
                                console.log(`Sticker processed for ${processTime(t, moment())} seconds`)
                                await hisoka.sendText(from, ind.ok())
                            })
                    } catch (err) {
                        console.error(err)
                        await hisoka.reply(from, ind.videoLimit(), id)
            ...
            case 'emojistiker':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (args.length !== 1) return hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
            ...
            case 'mlewd':
                ...
                if (isGroupMsg) {
                    ...
                    if (!isPremium) return await hisoka.reply(from, ind.notPremium(), id)
                    await hisoka.reply(from, ind.botNotPremium(), id)
                } else {
                    if (!isPremium) return await hisoka.reply(from, ind.notPremium(), id)
                    await hisoka.reply(from, ind.botNotPremium(), id)
                }
            ...
            case 'fetish':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (ar.length !== 1) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (isGroupMsg) {
                    if (!isNsfw) return await hisoka.reply(from, ind.notNsfw(), id)
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
            ...
            case 'nh':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (args.length !== 1) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (isNaN(Number(args[0]))) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (isGroupMsg) {
                    if (!isNsfw) return await hisoka.reply(from, ind.notNsfw(), id)
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    ...
                    if (validate === true) {
                        ...
                        await hisoka.reply(from, ind.nhFalse(), id)
                    }
                } else {
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
            ...
            case 'revoke':
                if (!isRegistered) return await hisoka.reply(from, ind.notRegistered(), id)
                if (!isGroupMsg) return await hisoka.reply(from, ind.groupOnly(), id)
                if (!isGroupAdmins) return hisoka.reply(from, ind.adminOnly(), id)
                if (!isBotGroupAdmins) return hisoka.reply(from, ind.botNotAdmin(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
            ...
            case 'linkgroup':
                ...
                if (!isGroupMsg) return await hisoka.reply(from, ind.groupOnly(), id)
                if (!isGroupAdmins) return await hisoka.reply(from, ind.adminOnly(), id)
                if (!isBotGroupAdmins) return await hisoka.reply(from, ind.botNotAdmin(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
            ...
            case 'mutegc':
                ...
                if (ar[0] === 'enable') {
                    ...
                    await hisoka.sendText(from, ind.gcMute())
                } else if (ar[0] === 'disable') {
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    await hisoka.setGroupToAdminsOnly(groupId, false)
                    await hisoka.sendText(from, ind.gcUnmute())
                } else {
                    await hisoka.reply(from, ind.wrongFormat(), id)
                }
            break
            ...
            case 'kick':
                ...
                if (!isGroupAdmins) return await hisoka.reply(from, ind.adminOnly(), id)
                if (!isBotGroupAdmins) return await hisoka.reply(from, ind.botNotAdmin(), id)
                if (mentionedJidList.length === 0) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (mentionedJidList[0] === botNumber) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await hisoka.sendTextWithMentions(from, `Good bye~\n${mentionedJidList.map(x => `@${x.replace('@c.us', '')}`).join('\n')}`)
                for (let i of mentionedJidList) {
                    if (groupAdmins.includes(i)) return await hisoka.sendText(from, ind.wrongFormat())
            ...
            case 'promote':
                ...
                if (!isGroupAdmins) return await hisoka.reply(from, ind.adminOnly(), id)
                if (!isBotGroupAdmins) return await hisoka.reply(from, ind.botNotAdmin(), id)
                if (mentionedJidList.length !== 1) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (mentionedJidList[0] === botNumber) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (groupAdmins.includes(mentionedJidList[0])) return await hisoka.reply(from, ind.adminAlready(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
            ...
            case 'demote':
                ...
                if (mentionedJidList.length !== 1) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (mentionedJidList[0] === botNumber) return await hisoka.reply(from, ind.wrongFormat(), id)
                if (!groupAdmins.includes(mentionedJidList[0])) return await hisoka.reply(from, ind.notAdmin(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
            ...
            case 'antilink':
                ...
                if (!isBotGroupAdmins) return await hisoka.reply(from, ind.botNotAdmin(), id)
                if (ar[0] === 'enable') {
                    if (isDetectorOn) return await hisoka.reply(from, ind.detectorOnAlready(), id)
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    _antilink.push(groupId)
                    fs.writeFileSync('./database/group/antilink.json', JSON.stringify(_antilink))
                    await hisoka.reply(from, ind.detectorOn(name, formattedTitle), id)
                } else if (ar[0] === 'disable') {
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    _antilink.splice(groupId, 1)
                    fs.writeFileSync('./database/group/antilink.json', JSON.stringify(_antilink))
                    await hisoka.reply(from, ind.detectorOff(), id)
                } else {
                    await hisoka.reply(from, ind.wrongFormat(), id)
                }
            break
            case 'leveling':
                ...
                if (!isGroupAdmins) return await hisoka.reply(from, ind.adminOnly(), id)
                if (ar[0] === 'enable') {
                    if (isLevelingOn) return await hisoka.reply(from, ind.levelingOnAlready(), id)
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    _leveling.push(groupId)
                    fs.writeFileSync('./database/group/leveling.json', JSON.stringify(_leveling))
                    await hisoka.reply(from, ind.levelingOn(), id)
                } else if (ar[0] === 'disable') {
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    _leveling.splice(groupId, 1)
                    fs.writeFileSync('./database/group/leveling.json', JSON.stringify(_leveling))
                    await hisoka.reply(from, ind.levelingOff(), id)
                } else {
                    await hisoka.reply(from, ind.wrongFormat(), id)
                }
            break
            case 'welcome':
                ...
                if (!isGroupAdmins) return await hisoka.reply(from, ind.adminOnly(), id)
                if (ar[0] === 'enable') {
                    if (isWelcomeOn) return await hisoka.reply(from, ind.welcomeOnAlready(), id)
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    _welcome.push(groupId)
                    fs.writeFileSync('./database/group/welcome.json', JSON.stringify(_welcome))
                    await hisoka.reply(from, ind.welcomeOn(), id)
                } else if (ar[0] === 'disable') {
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    _welcome.splice(groupId, 1)
                    fs.writeFileSync('./database/group/welcome.json', JSON.stringify(_welcome))
                    await hisoka.reply(from, ind.welcomeOff(), id)
                } else {
                    await hisoka.reply(from, ind.wrongFormat(), id)
                }
            break
            ...
            case 'autostik':
                ...
                if (!isGroupAdmins) return await hisoka.reply(from, ind.adminOnly(), id)
                if (ar[0] === 'enable') {
                    if (isAutoStickerOn) return await hisoka.reply(from, ind.autoStikOnAlready(), id)
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    _autosticker.push(groupId)
                    fs.writeFileSync('./database/group/autosticker.json', JSON.stringify(_autosticker))
                    await hisoka.reply(from, ind.autoStikOn(), id)
                } else if (ar[0] === 'disable') {
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    _autosticker.splice(groupId, 1)
                    fs.writeFileSync('./database/group/autosticker.json', JSON.stringify(_autosticker))
                    await hisoka.reply(from, ind.autoStikOff(), id)
                } else {
                    await hisoka.reply(from, ind.wrongFormat(), id)
                }
            break
            case 'antinsfw':
                ...
                if (!isBotGroupAdmins) return await hisoka.reply(from, ind.botNotAdmin(), id)
                if (ar[0] === 'enable') {
                    if (isDetectorOn) return await hisoka.reply(from, ind.antiNsfwOnAlready(), id)
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    _antinsfw.push(groupId)
                    fs.writeFileSync('./database/group/antinsfw.json', JSON.stringify(_antinsfw))
                    await hisoka.reply(from, ind.antiNsfwOn(name, formattedTitle), id)
                } else if (ar[0] === 'disable') {
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await hisoka.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    _antinsfw.splice(groupId, 1)
                    fs.writeFileSync('./database/group/antinsfw.json', JSON.stringify(_antinsfw))
                    await hisoka.reply(from, ind.antiNsfwOff(), id)
                } else {
                    await hisoka.reply(from, ind.wrongFormat(), id)
                }
            break
            ...
            case 'bc':
                ...
                await hisoka.reply(from, ind.doneOwner(), id)
            break
            case 'clearall':
                if (!isOwner) return await hisoka.reply(from, ind.ownerOnly(), id)
            ...
            case 'leaveall':
                ...
                await hisoka.reply(from, ind.doneOwner())
            break
            case 'getses':
                if (!isOwner) return await hisoka.reply(from, ind.ownerOnly(), id)
                const ses = await hisoka.getSnapshot()
                await hisoka.sendFile(from, ses, 'session.png', ind.doneOwner())
            break
            case 'ban':
                if (!isOwner) return await hisoka.reply(from, ind.ownerOnly(), id)
                if (ar[0] === 'add') {
            ...
            case 'mute':
                ...
                if (!isGroupAdmins) return await hisoka.reply(from, ind.adminOnly(), id)
                if (ar[0] === 'enable') {
                    if (isMute) return await hisoka.reply(from, ind.muteChatOnAlready(), id)
                    _mute.push(groupId)
                    fs.writeFileSync('./database/bot/mute.json', JSON.stringify(_mute))
                    await hisoka.reply(from, ind.muteChatOn(), id)
                } else if (ar[0] === 'disable') {
                    _mute.splice(groupId, 1)
                    fs.writeFileSync('./database/bot/mute.json', JSON.stringify(_mute))
                    await hisoka.reply(from, ind.muteChatOff(), id)
                } else {
                    await hisoka.reply(from, ind.wrongFormat(), id)
                }
            break
            case 'setname':
                if (!isOwner) return await hisoka.reply(from, ind.ownerOnly(), id)
                if (!q || q.length > 25) return await hisoka.reply(from, ind.wrongFormat(), id)
            ...
            default:
                if (isCmd) {
                    await hisoka.reply(from, ind.cmdNotFound(command), id)
                }
            break
        }
    } catch (err) {
